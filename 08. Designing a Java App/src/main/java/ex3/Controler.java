...
public class Controler {
    ...
    ArrayList<Controler> neighbourControllerList = new ArrayList<>();
    ...
    void addToNeighbourControllerList(Controler v) {
    ...
    void controlStep() {
        ...
        for (Segment segment : list) {
            if (segment.hasTrain()) {
                ...
                Controler neighbourController = neighbourControllerList.stream()
